...
this.wp = this.wp || {}, this.wp.apiFetch = function(e) {
    ...
    jqrR: function(e, t, r) {
                    ...
                    return h.a.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 2:
                                ...
                                return e.abrupt("return", r(t));
                            case 4:
                                return e.next = 6, J(w(w({}, (f = {
                                    per_page: 100
                                }, l = void 0, O = void 0, l = (p = t).path, O = p.url, w(w({}, Object(o.a)(p, ["path", "url"])), {}, {
        ...
        var z = function(e) {
            ...
            G = function(e) {
                var t = e.url,
                    ...
                    s = e.body,
                    p = e.headers;
                return p = q(q({}, H), p), n && (s = JSON.stringify(n), p["Content-Type"] = "application/json"), window.fetch(t || r, q(q(q({}, F), u), {}, {
                    body: s,
                    headers: p
                })).then((function(e) {
                    return Promise.resolve(e).then(z).catch((function(e) {
                        return R(e, a)
                    })).then((function(e) {
                        return A(e, a)
                    }))
        ...
        function I(e) {
            ...
            }), G)(e).catch((function(t) {
                return "rest_cookie_invalid_nonce" !== t.code ? Promise.reject(t) : window.fetch(I.nonceEndpoint).then(z).then((function(e) {
                    return e.text()
                })).then((function(t) {
                    return I.nonceMiddleware.nonce = t, I(e)
                }))
            }))
        }
        I.use = function(e) {
            U.unshift(e)
        }, I.setFetchHandler = function(e) {
            G = e
        }, I.createNonceMiddleware = u, I.createPreloadingMiddleware = j, I.createRootURLMiddleware = b, I.fetchAllMiddleware = S, I.mediaUploadMiddleware = N;
        var J = t.default = I
    },
    l3Sj: function(e, t) {
        ! function() {
