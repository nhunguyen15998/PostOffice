#pragma checksum "C:\CSharp\Project_PostOffice\Views\Send\Tracking.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "bbd7e0c2e9ba15a0c7a3106e1d03498f6519dddd"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"bbd7e0c2e9ba15a0c7a3106e1d03498f6519dddd", @"/Views/Send/Tracking.cshtml")]
        ...
        <div id=""content-inner"" class=""site-content-inner "">
            ...
            WriteLiteral(@">
                                                                <span class=""postoffice-form-control-wrap"" style=""width: 100%;"">
                                                                    <input type=""text"" name=""tracking"" class=""postoffice-form-control postoffice-text"" aria-invalid=""false"" placeholder=""Search your order…""");
            BeginWriteAttribute("style", " style=\"", 2099, "\"", 2107, 0);
            EndWriteAttribute();
            WriteLiteral(@">
                                                                </span>
                                                            </div>
                    ...
                    response.forEach(item => {
                        let tracking = `<div class=""align-items-center d-flex"" style=""width: fit-content;margin-bottom: 45px;"">
                                            ...
                                            <div style=""box-shadow: 0 3px 10px rgb(0 0 0 / 0.2);width: 100%;background-color: pink;padding: 15px 25px;margin-left: 200px;"">
                                                <p class=""mb-0"" style=""font-s");
            WriteLiteral(@"ize: 16px;"">Status: ${item.Description}</p>
