...
namespace post_office.Migrations
{
    ...
    [Migration("20220504171318_Modify_ProductBillDetail")]
    partial class Modify_ProductBillDetail
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("post_office.Entities.Bill", b =>
                {
                    ...
                    b.HasOne("post_office.Entities.Service", "Service")
                        .WithMany()
            ...
            modelBuilder.Entity("post_office.Entities.Order", b =>
                {
                    b.HasOne("post_office.Entities.VNCity", "FromCity")
                        .WithMany()
                        .HasForeignKey("FromCityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("post_office.Entities.VNState", "FromProvince")
                        .WithMany()
                        .HasForeignKey("FromProvinceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("post_office.Entities.VNWard", "FromWard")
                        .WithMany()
                    ...
                    b.HasOne("post_office.Entities.VNCity", "ToCity")
                        .WithMany()
                        .HasForeignKey("ToCityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("post_office.Entities.VNState", "ToProvince")
                        .WithMany()
                        .HasForeignKey("ToProvinceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("post_office.Entities.VNWard", "ToWard")
                        .WithMany()
